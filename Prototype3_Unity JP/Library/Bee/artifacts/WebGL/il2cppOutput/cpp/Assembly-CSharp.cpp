...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_Start_m1D83076E8B136A71051F2F02545EE04947D3A8CF (PlayerController_t7E8D7042FA2D0DFEC54A1FCDF395161D88DAAE95* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___playerAnim_9 = L_1;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___playerAnim_9), (void*)L_1);
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_Update_m1F4051EB5BCBCCE5EEE2E3E49B7E278C3B14EC33 (PlayerController_t7E8D7042FA2D0DFEC54A1FCDF395161D88DAAE95* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		float L_4 = __this->___jumpForce_6;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_5;
		L_5 = Vector3_op_Multiply_m87BA7C578F96C8E49BB07088DAAC4649F83B0353_inline(L_3, L_4, NULL);
		...
		Animator_t8A52E42AE54F76681838FE9E632683EF3952E883* L_6 = __this->___playerAnim_9;
		Animator_SetTrigger_mC9CD54D627C8843EF6E159E167449D216EF6EB30(L_6, _stringLiteral1625B4B9C4A74413B07D2018D406E68C6755A804, NULL);
		// dirtParticle.Stop();
		ParticleSystem_tB19986EE308BD63D36FB6025EEEAFBEDB97C67C1* L_7 = __this->___dirtParticle_11;
...
IL_0066:
	{
		...
		bool L_10 = __this->___isGameOver_8;
		if (!L_10)
		{
			goto IL_0075;
		}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void SpawnManager_Start_m65C9EA67649948222CFF4FBBF77BE2319D813DAF (SpawnManager_tD38605BF221D4CC849CF709A85499D2B698FD6FC* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		__this->___spawnInterval_8 = L_0;
		// InvokeRepeating ("SpawnObstacle", startDelay, spawnInterval);
		float L_1 = __this->___startDelay_6;
		float L_2 = __this->___spawnInterval_8;
		MonoBehaviour_InvokeRepeating_mF208501E0E4918F9168BBBA5FC50D8F80D01514D(__this, _stringLiteral6A9FD50EBD1DD8DDF5413D5B5783D8321D1DB75F, L_1, L_2, NULL);
		// playerControllerScript = GameObject.Find("Player").GetComponent<PlayerController>();
		...
		__this->___playerControllerScript_7 = L_4;
		Il2CppCodeGenWriteBarrier((void**)(&__this->___playerControllerScript_7), (void*)L_4);
		// }
		return;
	}
}
